...
// Base Url
export const backDomain = 'demoprmsbak.helpahand1234demo.com';
export const frontDomain = 'demoprms.helpahand1234demo.com';

export const forntUrl = `https://${frontDomain}/`;
...
export const environment = {
  ...
  // Absolute links
  apiUrl: baseUrl + 'api/',
  imagesUrl: baseUrl + 'uploadFiles/',
  registrationLink: forntUrl + 'auth/registration',
  profileLink: forntUrl +'activities/overview',
  // Relative Urls
  avatarImage: './assets/media/avatars/blank.png',
  // Panel links
  ...
  baseLinkUrl: 'helpahand1234demo.com/terminal',
  serverImageUrl: 'https://demoprmsbak.helpahand1234demo.com',
  appDemos: {
    'demo1': {
      'title': 'Demo 1',
