...
import { RewardDetailsComponent } from '../../activities/_dialogs/reward-details/reward-details.component';
// import { RewardDetailsComponent } from '../../_dialogs/reward-details/reward-details.component';
@Component({
  selector: 'prms-reward-chart',
  templateUrl: './reward-chart.component.html',
  styleUrls: ['./reward-chart.component.scss'],
})
export class RewardChartComponent implements OnInit {
  chartOptions: any = {};

  constructor(private split: SplitNumberPipe, private dialog: MatDialog) {}
  ngOnInit(): void {
