...
import { MarketersCategoriesComponent } from '../../_dialogs/marketers-categories/marketers-categories.component';
...
export class MarketersListComponent implements OnInit {
  ...
  tooltips = AdministrationTooltips.users.marketersList;
